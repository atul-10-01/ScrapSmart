  ...
  return (
    <div id='blogs' className='relative border-t mt-20 border-neutral-800 min-h-[800px]'>
      ...
      <div className='grid grid-cols-1 gap-4 px-4 py-8 mt-5 sm:grid-cols-2 lg:grid-cols-3'>
        <div className='bg-[#212121] pb-4 rounded-lg shadow-md max-w-sm mx-auto hover:shadow-gray-400/40'>
          <Link to="/blog1"><img src={blog1} alt='Understanding Electronic Waste' className='w-full h-56 object-cover rounded-t-lg' /></Link>
          <div className='p-4'>
            <h3 className='text-lg font-semibold text-[#1BC559] mb-2'>Understanding Electronic Waste</h3>
        ...
        <div className='bg-[#212121] pb-4 rounded-lg shadow-md max-w-sm mx-auto hover:shadow-gray-400/40'>
          ...
          <div className='p-4'>
            <h3 className='text-lg font-semibold text-[#1BC559] mb-2'>How to Manage Your Electronic Devices Responsibly</h3>
        ...
        <div className='bg-[#212121] pb-4 rounded-lg shadow-md max-w-sm mx-auto hover:shadow-gray-400/40'>
          ...
          <div className='p-4'>
            <h3 className='text-lg font-semibold text-[#1BC559] mb-2'>Importance of Responsible Disposal of Electronic Waste</h3>
        ...
        <div className='bg-[#212121] pb-4 rounded-lg shadow-md max-w-sm mx-auto hover:shadow-gray-400/40'>
          ...
          <div className='p-4'>
            <h3 className='text-lg font-semibold text-[#1BC559] mb-2'>E-waste in India and Developed Countries</h3>
        ...
        <div className='bg-[#212121] pb-4 rounded-lg shadow-md max-w-sm mx-auto hover:shadow-gray-400/40'>
          ...
          <div className='p-4'>
            <h3 className='text-lg font-semibold text-[#1BC559] mb-2'>Where Does Your Electronic Waste Go?</h3>
        ...
        <div className='bg-[#212121] pb-4 rounded-lg shadow-md max-w-sm mx-auto hover:shadow-gray-400/40'>
          ...
          <div className='p-4'>
            <h3 className='text-lg font-semibold text-[#1BC559] mb-2'>What are the Long-term Implications of E-Waste Mining?</h3>
